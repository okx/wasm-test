...
res=$(exchaincli tx wasm store ../contract/cw20-base/artifacts/cw20_base.wasm --instantiate-everybody=true --from captain $TX_EXTRA)
...
res=$(exchaincli tx wasm store ../contract/cw20-base/artifacts/cw20_base.wasm --instantiate-only-address="${captain0x}" --from captain $TX_EXTRA)
...
echo "## store cw20 contract...only-address"
res=$(exchaincli tx wasm store ../contract/cw20-base/artifacts/cw20_base.wasm --instantiate-only-address="${captain}" --from captain $TX_EXTRA)
...
res=$(exchaincli tx wasm store ../contract/cw20-base/artifacts/cw20_base.wasm --from captain $TX_EXTRA)
...
res=$(exchaincli tx wasm store ../contract/cw20-base/artifacts/cw20_base.wasm.gz --from captain $TX_EXTRA)
echo "store cw20 contract succeed"
...
res=$(exchaincli tx wasm store ../contract/test/invalid.wasm --from captain $TX_EXTRA)
raw_log=$(echo "$res" | jq '.raw_log' | sed 's/\"//g')
...
res=$(exchaincli tx wasm store ../contract/cw4-stake/artifacts/cw4_stake.wasm --from admin18 $TX_EXTRA)
...
#############    migrate contract     ###############
#####################################################
res=$(exchaincli tx wasm store ../contract/test/burner.wasm --from admin18 $TX_EXTRA)
...
res=$(exchaincli tx wasm store ../contract/test/burner.wasm --from captain $TX_EXTRA)
burner_code_id=$(echo "$res" | jq '.logs[0].events[1].attributes[0].value' | sed 's/\"//g')
...
res=$(exchaincli tx wasm store ../contract/cw4-stake/artifacts/cw4_stake.wasm --from captain $TX_EXTRA)
echo "store cw4-stake succeed"
cw4_code_id=$(echo "$res" | jq '.logs[0].events[1].attributes[0].value' | sed 's/\"//g')
