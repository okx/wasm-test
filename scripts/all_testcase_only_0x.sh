...
addr2=$(exchaincli keys add addr2 -y 2>&1 | jq -r '.eth_address')  #0x
...
res=$(exchaincli tx wasm execute "$contractAddr" "{\"call_submsg\":{\"call\":[{\"calltype\":\"bankmsg\",\"to\":\"0xf1829676DB577682E944fc3493d451B67Ff3E29F\",\"subcall\":\"\",\"amount\":\"1\",\"replyon\":\"none\",\"replyid\":\"1\",\"gaslimit\":\"0\"}]}}" --fees 0.001okt --from user -b block -y)
raw_log=$(echo "$res" | jq '.raw_log')
...
res=$(exchaincli tx wasm execute "$contractAddr" "{\"call_submsg\":{\"call\":[{\"calltype\":\"stakingmsg\",\"to\":\"0xf1829676DB577682E944fc3493d451B67Ff3E29F\",\"subcall\":\"\",\"amount\":\"1\",\"replyon\":\"none\",\"replyid\":\"1\",\"gaslimit\":\"0\"}]}}" --fees 0.001okt --from user -b block -y)
raw_log=$(echo "$res" | jq '.raw_log')
failed_log="unknown message from the contract: no handler found"
contains "$raw_log" "$failed_log"

echo "11.#### 1 submsg failed with distrmsg"
res=$(exchaincli tx wasm execute "$contractAddr" "{\"call_submsg\":{\"call\":[{\"calltype\":\"distrmsg\",\"to\":\"0xf1829676DB577682E944fc3493d451B67Ff3E29F\",\"subcall\":\"\",\"amount\":\"1\",\"replyon\":\"none\",\"replyid\":\"1\",\"gaslimit\":\"0\"}]}}" --fees 0.001okt --from user -b block -y)
raw_log=$(echo "$res" | jq '.raw_log')
failed_log="unknown message from the contract: no handler found"
contains "$raw_log" "$failed_log"

echo "12.#### 1 submsg failed with govmsg"
res=$(exchaincli tx wasm execute "$contractAddr" "{\"call_submsg\":{\"call\":[{\"calltype\":\"govmsg\",\"to\":\"0xf1829676DB577682E944fc3493d451B67Ff3E29F\",\"subcall\":\"\",\"amount\":\"1\",\"replyon\":\"none\",\"replyid\":\"1\",\"gaslimit\":\"0\"}]}}" --fees 0.001okt --from user -b block -y)
raw_log=$(echo "$res" | jq '.raw_log')
failed_log="unknown message from the contract: no handler found"
contains "$raw_log" "$failed_log"

echo "13.#### 1 submsg failed with ibcmsg"
res=$(exchaincli tx wasm execute "$contractAddr" "{\"call_submsg\":{\"call\":[{\"calltype\":\"ibcmsg\",\"to\":\"0xf1829676DB577682E944fc3493d451B67Ff3E29F\",\"subcall\":\"\",\"amount\":\"1\",\"replyon\":\"none\",\"replyid\":\"1\",\"gaslimit\":\"0\"}]}}" --fees 0.001okt --from user -b block -y)
raw_log=$(echo "$res" | jq '.raw_log')
